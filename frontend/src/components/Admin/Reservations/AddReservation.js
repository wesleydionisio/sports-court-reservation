// src/components/Admin/Reservations/AddReservation.js
...
const AddReservation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('/api/reservations', formData); // Rota protegida (admin)
      setLoading(false);
    ...
    <div>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Button variant="primary" type="submit" disabled={loading}>
          {loading ? <Spinner as="span" animation="border" size="sm" role="status" aria-hidden="true" /> : 'Criar Reserva'}
        </Button>
      </Form>
    </div>
  );
